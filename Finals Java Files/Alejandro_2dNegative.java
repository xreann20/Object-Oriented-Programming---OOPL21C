...
public class Alejandro_2dNegative {
	public static void main(String[] args) {
		...
		//Call CheckNegativesOnArray
		System.out.println("The number of negative elements in the 2D Array is " + checkNegativesOnArray(array_2d) + ".");
	}
	
		public static int checkNegativesOnArray(int array_2d[][])
		{
			int neg_num=0;
			for(int row=0; row<array_2d.length; row++)
			{
				...
				for(int col=0; col<array_2d[0].length; col++)
				{
					...
					{
						//Add + 1 to every negative number processed
						neg_num=neg_num+1;
					}
				}
			}
